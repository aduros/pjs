...
module.exports = opts => {
    ...
    const pjsModule = opts.pjsModule || "@aduros/pjs";
    ...
    switch (mode) {
    case "csv":
        iterateJs = `const {eachCsv, print} = require("${pjsModule}");\n`;
    ...
    case "json":
        iterateJs = `
            const {eachJson, print} = require("${pjsModule}");
    ...
    default:
        iterateJs = `
            const {eachLine, print} = require("${pjsModule}");
