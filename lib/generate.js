...
module.exports = opts => {
    ...
    const pjsModule = opts.pjsModule || "pjs-tool";
    ...
    case "csv":
        iterateJs = `
            const {eachCsv, print} = require("${pjsModule}");
            BEFORE;
        `;
    ...
    case "html":
        iterateJs = `
            const {eachHtml, print} = require("${pjsModule}");
            BEFORE;
    ...
    case "xml":
        iterateJs = `
            const {eachXml, print} = require("${pjsModule}");
            BEFORE;
